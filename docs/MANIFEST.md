...
| Decisions | D-001 … D-023, append-only, integrity-hashed |
...
| Invariants | INV-01 … INV-19; 18 executable, 29 negative tests, all fail when violated; INV-14 is runtime-enforced |
...
tests, 433 unit tests, both static validators, the strict spec graph, the
